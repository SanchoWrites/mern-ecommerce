...
app.get('/popularindesktops', async(req, res) => {
    let products = await Product.find({category: "pc"});
    let popular_desktops = products.slice(0, 4);
    console.log("Popular in desktops fetched");
    res.send(popular_desktops);
})
